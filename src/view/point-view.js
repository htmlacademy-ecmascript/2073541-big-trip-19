...
function createListItemTemplate(point, allOffers, destinations) {
  ...
  const pointDuration = getEventDuration(dateFrom, dateTo);

  return (
    `<li class="trip-events__item">
      <div class="event">
        <time class="event__date" datetime=${dayjs(dateFrom)}>${dayjs(dateFrom).format('DD MMM')}</time>
...
export default class PointView extends AbstractView {
  ...
  constructor({point, allOffers, destinations, onEditClick, onFavoriteClick }) {
    super();
    this.#point = point;
